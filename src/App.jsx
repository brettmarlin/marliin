...
const FALLBACK = {
  creds: [{ name: "Altana AI", role: "Head of Product Design" }, { name: "Sayari", role: "Head of Product Design" }, { name: "Carta", role: "Head of Product Design" }, { name: "Mixpanel", role: "Head of Design" }, { name: "Blend", role: "Head of Product Design" }, { name: "AOL", role: "Agency Partner" }],
